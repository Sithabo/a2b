  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.userName}>John Musa</Text>
        <Text style={styles.userPhone}>077-123-4567</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.supportContainer}>
          ...
          <View style={styles.supportCard}>
            ...
            <TouchableOpacity style={styles.callSupportButton} activeOpacity={0.85}>
              <PhoneCall color="white" size={20} />
              <Text style={styles.callSupportText}>Call A2B Support</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.reportIssueButton} activeOpacity={0.7}>
